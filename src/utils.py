...
@torch.no_grad()
def extract_image_features(dataset: Dataset, clip_model: CLIP, batch_size: Optional[int] = 16,
                           num_workers: Optional[int] = 8) -> Tuple[torch.Tensor, List[str]]:
    """
    ...
    for batch in tqdm(loader):
        ...
        if names is None:
            ...
            pairids.extend(batch.get('pair_id'))
    ...
    return index_features, index_names, pairids