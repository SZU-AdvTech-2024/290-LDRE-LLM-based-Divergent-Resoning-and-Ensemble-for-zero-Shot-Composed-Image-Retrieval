...
class CIRRDataset(Dataset):
   ...
   The dataset can be used in 'relative' or 'classic' mode:
    ...
    def __init__(self, dataset_path: Union[Path, str], split: Literal['train', 'val', 'test'],
        ...
        with open( self.dataset_path / f'cirr/captions/cap.rc2.{split}.json') as f:
        ...
        with open(self.dataset_path / f'cirr/image_splits/split.rc2.{split}.json') as f:
    ...
    def __getitem__(self, index) -> dict:
        try:
            if self.mode == 'relative':
                ...
                multi_opt = self.triplets[index]['multi_caption_flo2'][:args.nums_caption]
                multi_gpt_opt = self.triplets[index]['multi_gpt-4o-mini_flo2'][:args.nums_caption]
...
class CIRCODataset(Dataset):
    ...
    def __init__(self, dataset_path: Union[str, Path], split: Literal['val', 'test'],
        ...
        with open("../../../../data/circo/COCO2017_unlabeled/annotations/image_info_unlabeled2017.json", "r") as f:
            imgs_info = json.load(f)

        self.img_paths = ["../../../../data/circo/COCO2017_unlabeled/unlabeled2017/" + img_info["file_name"] for img_info in
                          imgs_info["images"]]
        ...
        with open("../../../../code/project/LDRE-main/CIRCO/annotations/test.json", "r") as f:
    ...
    def __getitem__(self, index) -> dict:
        ...
        if self.mode == 'relative':
            ...
            multi_opt = self.annotations[index]['multi_caption_flo2'][:args.nums_caption]
            multi_gpt_opt = self.annotations[index]['multi_gpt-4o-mini_flo2'][:args.nums_caption]
