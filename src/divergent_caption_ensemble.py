...
#     # Create the test dataloader
#     # num_workers
#     relative_test_loader = DataLoader(dataset=relative_test_dataset, batch_size=4, num_workers=1,
...
#         multi_caption = batch['multi_opt']
#         multi_gpt_caption = batch['multi_gpt_opt']
