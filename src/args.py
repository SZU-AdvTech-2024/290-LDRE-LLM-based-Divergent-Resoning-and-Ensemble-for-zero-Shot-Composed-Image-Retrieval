...
class args_define():
    ...
    parser.add_argument("--dataset", type=str, default='cirr', choices=['cirr', 'circo', 'fashioniq'], help="Dataset to use")
    parser.add_argument("--dataset-path", type=str, help="Path to the dataset", default='CIRR')
    ...
    parser.add_argument("--nums_caption", type=int, default=3)
    
    parser.add_argument("--use_momentum_strategy", type=bool, default=False)
